...
//!evaluateOnInput("IS_IN_STATE(processB, processB.Waiting) || IS_IN_STATE(processA, processA.Waiting)")
jsonEx = {
    "initial": ["1"],  
    "actions": {
        "1": [ ["!(IS_IN_STATE(processB, processB.Waiting) || IS_IN_STATE(processA, processA.Waiting))", "2"], ["true", "1"] ],
        "2": [["!(IS_IN_STATE(processB, processB.Waiting) || IS_IN_STATE(processA, processA.Waiting))", "2"]],
    },
    "accepting": ["2"]
}
